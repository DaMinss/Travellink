...
import com.example.travellink.ConfirmDialogFragment;
...
public class CreateNewTrip extends AppCompatActivity {
    TextView title;
    TextInputLayout name, depart, arrive, date, note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrive.animate().translationX(0).alpha(1).setDuration(800).setStartDelay(500).start();
    ...
    protected boolean validation() {
        if (tripName.getText().toString().isEmpty()) {
            ...
            depart.setError("You need to enter your departure destination !");
            return false;
